...
- **Kanji-Only Processing**: Only adds furigana to kanji characters (一-龯), leaving hiragana and katakana words unchanged
- **Dictionary Reading Display**: Converts dictionary katakana readings to hiragana for cleaner furigana display (e.g., カンジ → かんじ)
